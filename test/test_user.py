...
class UserTestCase(unittest.TestCase):
    ...
    def test_user(self):
        ...
        self.assertEqual(user.firstname, "Axel")
        self.assertEqual(user.lastname, "Guyot")
        self.assertEqual(user.email, "axeluser@gmail.com")
        self.assertEqual(user.password, "user1234")
    ...
    def test_find_all(self):
        user = self.__new_user()
        user1 = self.__new_user()
        user1.email = "axeluser@gmail.com"
        user1.phone = "13997518993"
        user_save = repository.save(user)
    ...
    def test_find_by(self):
        ...
        self.assertIsNotNone(user_save.id)
        self.assertGreater(user_save.id, 0)
        user_find = repository.find_by(email = "axeluser@gmail.com")
        self.assertIsNotNone(user_find)
    ...
    def test_update(self):
        ...
        self.assertTrue(Security.check_password(user.password, "user1234"))
    ...
    def __new_user(self):
        ...
        user.firstname = "Axel"
        user.lastname = "Guyot"
        user.email = "axeluser@gmail.com"
        user.password = "user1234"
        user.phone = "13997518993"
        return user
